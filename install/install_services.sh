...
sudo cp -rf service_files/tcs_case_ui.service /etc/systemd/system/
sudo cp -rf service_files/tcs_pipe.service /etc/systemd/system/
sudo cp -rf service_files/tcs_web_ui.service /etc/systemd/system/
sudo cp -rf service_files/x11vnc@gdm.service /etc/systemd/system/
sudo cp -rf service_files/x11vnc@tch.service /etc/systemd/system/
